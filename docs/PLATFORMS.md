...
| **Instagram** | yt-dlp (raw, process=False) | yt-dlp (Original + best-H.264 MP4; social filename stem; **carousels → one job, ZIP of all videos**) | — (batch paste instead) | instagram.com cookies in `COOKIES_*` when anonymous access is blocked |
